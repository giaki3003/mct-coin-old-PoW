...
typedef enum mctconsensus_error_t
{
    mctconsensus_ERR_OK = 0,
...
EXPORT_SYMBOL int mctconsensus_verify_script(const unsigned char *scriptPubKey, unsigned int scriptPubKeyLen,
                                    const unsigned char *txTo        , unsigned int txToLen,
                                    unsigned int nIn, unsigned int flags, mctconsensus_error* err);

EXPORT_SYMBOL unsigned int mctconsensus_version();
