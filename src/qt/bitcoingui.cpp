    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("MCT Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MCT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mct: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About MCT Core"), this);
    aboutAction->setStatusTip(tr("Show information about MCT Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MCT Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MCT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MCT addresses"));
    ...
    openAction->setStatusTip(tr("Open a mct: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MCT Core help message to get a list with possible MCT Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("MCT Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MCT network", "", count));
    } else {
...
{
    QString strTitle = tr("MCT Core"); // default title
