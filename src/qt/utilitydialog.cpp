    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("MCT Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About MCT Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  mct-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the MCT in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 MCT, 0.1 MCT, 1 MCT and 10 MCT -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("MCT Core is shutting down...") + "<br /><br />" +
