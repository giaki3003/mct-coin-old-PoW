/* src/config/mct-config.h.  Generated from mct-config.h.in by configure.  */
/* src/config/mct-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The MCT Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "MCT Core"
...
#define PACKAGE_BUGREPORT "https://github.com/mctpay/mct/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "MCT Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "MCT Core 1.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "mctcore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://mctpay.org/"
