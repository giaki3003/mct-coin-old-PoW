...
pkgdatadir = $(datadir)/mctcore
pkgincludedir = $(includedir)/mctcore
pkglibdir = $(libdir)/mctcore
pkglibexecdir = $(libexecdir)/mctcore
...
CONFIG_HEADER = $(top_builddir)/src/config/mct-config.h
CONFIG_CLEAN_FILES = libmctconsensus.pc share/setup.nsi \
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/mct-config.h.in \
...
ACLOCAL = ${SHELL} /home/andreas/_NEWCOINS/testmct/mct-coin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/andreas/_NEWCOINS/testmct/mct-coin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/andreas/_NEWCOINS/testmct/mct-coin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/andreas/_NEWCOINS/testmct/mct-coin/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
...
CXXFLAGS = -g -O2 -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter -fvisibility=hidden
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = false
...
MAINT = 
MAKEINFO = ${SHELL} /home/andreas/_NEWCOINS/testmct/mct-coin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = mctcore
PACKAGE_BUGREPORT = https://github.com/MCT/MCT/issues
PACKAGE_NAME = MCT Core
PACKAGE_STRING = MCT Core 0.18.0
PACKAGE_TARNAME = mctcore
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/andreas/_NEWCOINS/testmct/mct-coin
abs_srcdir = /home/andreas/_NEWCOINS/testmct/mct-coin
abs_top_builddir = /home/andreas/_NEWCOINS/testmct/mct-coin
abs_top_srcdir = /home/andreas/_NEWCOINS/testmct/mct-coin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/andreas/_NEWCOINS/testmct/mct-coin/build-aux/install-sh
...
pkgconfig_DATA = libmctconsensus.pc
BITCOIND_BIN = $(top_builddir)/src/mctd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/mct-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/mct-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = MCT-Qt.app
OSX_DMG = MCT-Core.dmg
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_mct_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info rpc_test.info rpc_test_filtered.info \
  leveldb_baseline_filtered.info test_mct_coverage.info test_mct.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/MCT-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/mct-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/mct-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/mct-config.h
$(top_srcdir)/src/config/mct-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/mct-config.h src/config/stamp-h1
libmctconsensus.pc: $(top_builddir)/config.status $(srcdir)/libmctconsensus.pc.in
...
$(OSX_APP)/Contents/MacOS/MCT-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/MCT-Qt

$(OSX_DMG): $(APP_DIST_EXTRAS)
	$(GENISOIMAGE) -no-cache-inodes -D -l -probe -V "MCT-Core" -no-pad -r -dir-mode 0755 -apple -o $@ dist
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/MCT-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_mct.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_mct -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_mct_filtered.info: test_mct.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_mct_filtered.info
#	$(MKDIR_P) qa/tmp
...
#rpc_test.info: test_mct_filtered.info
...
#test_mct_coverage.info: baseline_filtered_combined.info test_mct_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_mct_filtered.info -o $@

#total_coverage.info: baseline_filtered_combined.info test_mct_filtered.info block_test_filtered.info rpc_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_mct_filtered.info -a block_test_filtered.info -a rpc_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_mct.coverage/.dirstamp:  test_mct_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_mct.coverage/.dirstamp total.coverage/.dirstamp

# MCT: disable the test until upstream switches from convoluted comparison tool
...
clean-local:
	rm -rf coverage_percent.txt test_mct.coverage/ total.coverage/ qa/tmp/ cache/ $(OSX_APP)
