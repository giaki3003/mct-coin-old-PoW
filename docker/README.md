...
official/supported Docker Images found at https://hub.docker.com/r/mctpay/mctd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/mctpay/mctd-develop/ when changing the above text**